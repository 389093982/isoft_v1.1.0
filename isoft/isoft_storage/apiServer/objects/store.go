...
func storeObject(r io.Reader, hash string, size int64) (int, error) {
	defer utils.RecordTimeCostForMethod("apiServer objects storeObject", time.Now())
	...
	defer utils.RecordTimeCostForMethod("apiServer objects storeObject and commit", time.Now())
	// 重新计算 hash 值
