...
// 保存为历史版本
export const SaveHistory = (offset,current_page) => ajax(BASE_URL+"/iwork/saveHistory", {offset,current_page},'POST');

// 分页查询历史版本信息
export const FilterPageWorkHistory = (work_id) => ajax(BASE_URL+"/iwork/filterPageWorkHistory", {work_id},'POST');
