...
// 添加 workstep 记录
export const AddWorkStep = (work_id,work_step_id,work_step_name,work_step_input,work_step_output) => ajax(BASE_URL+"/iwork/addWorkStep", {work_id,work_step_id,work_step_name,work_step_input,work_step_output},'POST');
