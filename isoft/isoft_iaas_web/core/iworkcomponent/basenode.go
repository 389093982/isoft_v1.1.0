...
// paramValue 来源于前置节点
func (this *BaseNode) parseAndFillParamVauleWithNode(paramVaule string, dataStore *iworkdata.DataStore) interface{} {
...
func (this *BaseNode) SubmitParamOutputSchemaDataToDataStore(workStep *iwork.WorkStep,dataStore *iworkdata.DataStore, tmpDataMap map[string]interface{})  {
