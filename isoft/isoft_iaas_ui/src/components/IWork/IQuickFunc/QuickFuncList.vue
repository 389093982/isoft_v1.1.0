    ...
    data(){
      return {
        ...
        funcs:[
          ...
          {funcDemo:"stringsCheckEmpty($str1)",funcDesc:"字符串是否为空",},
          ...
          {funcDemo:"boolAnd($bool1,$bool2)",funcDesc:"判断bool1和bool2同时满足",},
          {funcDemo:"boolOr($bool,$bool2)",funcDesc:"判断bool1和bool2只要一个满足即可",},
          {funcDemo:"boolNot($bool)",funcDesc:"bool值取反",},
          {funcDemo:"stringsUUID()",funcDesc:"生成随机UUID信息",},
          {funcDemo:"checkEmpty($var)",funcDesc:"判断变量是否为空",},
